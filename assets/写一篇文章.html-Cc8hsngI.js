import{_ as s,c as e,e as a,o as i}from"./app-BNNcboHM.js";const t={};function l(d,n){return i(),e("div",null,n[0]||(n[0]=[a(`<h1 id="写第一篇文章" tabindex="-1"><a class="header-anchor" href="#写第一篇文章"><span>写第一篇文章</span></a></h1><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>note（根目录）
└—docs 
  └——.vuepress 
    ├———— public         
    └———— config.js      
