import{_ as n,c as a,a as e,o as l}from"./app-BHuffSQg.js";const i={};function p(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="linux运维速查宝典" tabindex="-1"><a class="header-anchor" href="#linux运维速查宝典"><span>Linux运维速查宝典</span></a></h1><h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令"><span>常用命令</span></a></h2><h3 id="查看当前进程状态-【ps】" tabindex="-1"><a class="header-anchor" href="#查看当前进程状态-【ps】"><span>查看当前进程状态：【ps】</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">ps aux|grep ktin </span>
