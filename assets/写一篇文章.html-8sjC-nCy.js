import{_ as n,o as s,c as e,e as a}from"./app-CYrzcX6G.js";const i={},t=a(`<h1 id="写第一篇文章" tabindex="-1"><a class="header-anchor" href="#写第一篇文章"><span>写第一篇文章</span></a></h1><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>note（根目录）
└—docs 
  └——.vuepress 
    ├———— public         
    └———— config.js      
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>访问项目<code>localhost:8080</code>，发现导航栏多了一个按钮，点击进去就是你的文章！</p>`,9),l=[t];function d(c,r){return s(),e("div",null,l)}const o=n(i,[["render",d],["__file","写一篇文章.html.vue"]]),u=JSON.parse('{"path":"/azilnote/%E5%86%99%E4%B8%80%E7%AF%87%E6%96%87%E7%AB%A0.html","title":"写第一篇文章","lang":"en-US","frontmatter":{"title":"写第一篇文章"},"headers":[],"git":{"updatedTime":1710772920000,"contributors":[{"name":"Fun_zil","email":"854257920@qq.com","commits":1}]},"filePathRelative":"azilnote/写一篇文章.md"}');export{o as comp,u as data};
