import{_ as s,c as a,e,o as l}from"./app-CVA42f6w.js";const i={};function t(p,n){return l(),a("div",null,n[0]||(n[0]=[e(`<h1 id="linux运维速查宝典" tabindex="-1"><a class="header-anchor" href="#linux运维速查宝典"><span>Linux运维速查宝典</span></a></h1><h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令"><span>常用命令</span></a></h2><h3 id="查看当前进程状态-【ps】" tabindex="-1"><a class="header-anchor" href="#查看当前进程状态-【ps】"><span>查看当前进程状态：【ps】</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>ps aux|grep ktin 
//查看包含&quot;ktin&quot;字眼的进程的信息，其中第2列为PID

ps -ef|grep srm-esb-*
//查看以srm-esb-开头的进程的信息
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看磁盘占用情况-【df】" tabindex="-1"><a class="header-anchor" href="#查看磁盘占用情况-【df】"><span>查看磁盘占用情况：【df】</span></a></h3><p>df -h</p><h3 id="查看负载、内存、进程-【top】" tabindex="-1"><a class="header-anchor" href="#查看负载、内存、进程-【top】"><span>查看负载、内存、进程：【top】</span></a></h3><p>示例：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 该行跟命令uptime显示的内容相同。
# up 2 days：已使用2天
# 3 users：有3个当前用户
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看端口占用情况-【netstat】" tabindex="-1"><a class="header-anchor" href="#查看端口占用情况-【netstat】"><span>查看端口占用情况:【netstat】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#查看某个端口</span>
<span class="token function">lsof</span> <span class="token parameter variable">-i:8080</span>

<span class="token comment">#查看所有端口</span>
<span class="token function">netstat</span> <span class="token parameter variable">-tunlp</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="文件查找-【find】" tabindex="-1"><a class="header-anchor" href="#文件查找-【find】"><span>文件查找：【find】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 默认从当前目录查找；查找时默认包括子目录；</span>

<span class="token comment"># 1.按文件名查找  </span>
<span class="token function">find</span> test.txt  
<span class="token comment"># 在当前目录下查找test.txt文件  </span>
<span class="token function">find</span> / <span class="token parameter variable">-name</span> httpd.conf  
<span class="token comment"># 在根目录下查找文件httpd.conf  </span>
<span class="token function">find</span> /etc <span class="token parameter variable">-name</span> <span class="token string">&#39;\\*httpd\\*&#39;</span>  
<span class="token comment"># 在etc目录下查找名字含有&quot;httpd&quot;的文件</span>

<span class="token comment"># 2.**查询大文件**  </span>
<span class="token function">find</span> <span class="token builtin class-name">.</span> <span class="token parameter variable">-type</span> f <span class="token parameter variable">-size</span> +500M  
<span class="token comment"># 找出目录下（包括子目录）所有大小大于500M的文件</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="已删除文件但未释放空间-【lsof】" tabindex="-1"><a class="header-anchor" href="#已删除文件但未释放空间-【lsof】"><span>已删除文件但未释放空间：【lsof】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 查看被删除但是未释放空间的文件，其中第2列为pid</span>
<span class="token function">lsof</span> <span class="token operator">|</span> <span class="token function">grep</span> deleted

<span class="token comment"># 查看未释放空间文件在该pid下的文件句柄 （返回值类似： 3 -&gt; /delete.tmp，“3”就是文件句柄）</span>
ll /proc/<span class="token punctuation">[</span>pid<span class="token punctuation">]</span>/fd <span class="token operator">|</span> <span class="token function">grep</span> delete.tmp

<span class="token comment"># 将文件句柄置空，完成。</span>
<span class="token builtin class-name">echo</span> <span class="token operator">&gt;</span> /proc/PID/fd/<span class="token punctuation">[</span>文件句柄<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="文件上传、下载-【curl】" tabindex="-1"><a class="header-anchor" href="#文件上传、下载-【curl】"><span>文件上传、下载：【curl】</span></a></h3><h3 id="文本编辑-【vim】" tabindex="-1"><a class="header-anchor" href="#文本编辑-【vim】"><span>文本编辑：【vim】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">vim</span> systemOut.log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>i #进入编辑模式</p><p>编辑模式下：</p><ul><li>ESC #退出编辑模式</li><li>x #删除后面的字符</li><li>X #删除前面的字符</li><li>u #回滚</li></ul><p>非编辑模式下：</p><ul><li>:wq #保存并退出</li><li>:q! #直接退出不保存</li><li>:w [filename] #另存为</li><li>/ [关键字] #查找关键字（然后输入n搜索下一个）</li><li>Ctrl+F #下一页</li><li>Ctrl+B #上一页</li></ul><h3 id="查看linux版本-【hostnamectl】" tabindex="-1"><a class="header-anchor" href="#查看linux版本-【hostnamectl】"><span>查看Linux版本：【hostnamectl】</span></a></h3><h3 id="全文检索-【grep】" tabindex="-1"><a class="header-anchor" href="#全文检索-【grep】"><span>全文检索：【grep】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">grep</span> <span class="token parameter variable">--help</span>   
<span class="token comment"># 查看帮助</span>

<span class="token function">grep</span> <span class="token parameter variable">-lr</span> <span class="token string">&#39;string&#39;</span> /etc/  
<span class="token comment"># -l: 找出含有该字符串的文件  </span>
<span class="token comment"># -r: 同时从子目录查找  </span>
<span class="token comment"># -i: 忽略大小写</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="执行某段shell脚本-【source】" tabindex="-1"><a class="header-anchor" href="#执行某段shell脚本-【source】"><span>执行某段shell脚本：【source】</span></a></h3><p>假设有以下shell脚本：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># test.sh</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="以管理员身份运行命令-【sudo】" tabindex="-1"><a class="header-anchor" href="#以管理员身份运行命令-【sudo】"><span>以管理员身份运行命令：【sudo】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 以管理员身份浏览yum文件</span>
<span class="token function">sudo</span> <span class="token function">vim</span> /usr/bin/yum
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="文件操作-【touch、rm等】" tabindex="-1"><a class="header-anchor" href="#文件操作-【touch、rm等】"><span>文件操作：【touch、rm等】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">touch</span> <span class="token operator">&lt;</span>filename<span class="token operator">&gt;</span>   
...
<span class="token comment"># 强行删除文件或目录（不包括子目录）</span>
...
<span class="token comment"># 强行删除文件或目录（包括子目录）</span>
...
<span class="token comment"># 拷贝目录</span>
...
<span class="token comment"># 移动文件/文件重命名</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看linux的路由表-【route】" tabindex="-1"><a class="header-anchor" href="#查看linux的路由表-【route】"><span>查看Linux的路由表：【route】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@VM_139_74_centos ~<span class="token punctuation">]</span><span class="token comment"># route</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="文件内容检索、修改-【cat】" tabindex="-1"><a class="header-anchor" href="#文件内容检索、修改-【cat】"><span>文件内容检索、修改：【cat】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#查看text.txt的所有内容</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="滚动查看文件-【less】" tabindex="-1"><a class="header-anchor" href="#滚动查看文件-【less】"><span>滚动查看文件：【less】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#进入并查看文件</span>
LESS text.txt
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看日志-【tail】" tabindex="-1"><a class="header-anchor" href="#查看日志-【tail】"><span>查看日志：【tail】</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#滚动式查看日志</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="查看系统配置" tabindex="-1"><a class="header-anchor" href="#查看系统配置"><span>查看系统配置</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>#CPU个数、核数
lscpu
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,65)]))}const d=s(i,[["render",t],["__file","linux命令速查宝典.html.vue"]]),r=JSON.parse('{"path":"/devops/linux/linux%E5%91%BD%E4%BB%A4%E9%80%9F%E6%9F%A5%E5%AE%9D%E5%85%B8.html","title":"Linux运维速查宝典","lang":"en-US","frontmatter":{"title":"Linux运维速查宝典","sidebar":"auto"},"headers":[{"level":2,"title":"常用命令","slug":"常用命令","link":"#常用命令","children":[{"level":3,"title":"查看当前进程状态：【ps】","slug":"查看当前进程状态-【ps】","link":"#查看当前进程状态-【ps】","children":[]},{"level":3,"title":"查看磁盘占用情况：【df】","slug":"查看磁盘占用情况-【df】","link":"#查看磁盘占用情况-【df】","children":[]},{"level":3,"title":"查看负载、内存、进程：【top】","slug":"查看负载、内存、进程-【top】","link":"#查看负载、内存、进程-【top】","children":[]},{"level":3,"title":"查看端口占用情况:【netstat】","slug":"查看端口占用情况-【netstat】","link":"#查看端口占用情况-【netstat】","children":[]},{"level":3,"title":"文件查找：【find】","slug":"文件查找-【find】","link":"#文件查找-【find】","children":[]},{"level":3,"title":"已删除文件但未释放空间：【lsof】","slug":"已删除文件但未释放空间-【lsof】","link":"#已删除文件但未释放空间-【lsof】","children":[]},{"level":3,"title":"文件上传、下载：【curl】","slug":"文件上传、下载-【curl】","link":"#文件上传、下载-【curl】","children":[]},{"level":3,"title":"文本编辑：【vim】","slug":"文本编辑-【vim】","link":"#文本编辑-【vim】","children":[]},{"level":3,"title":"查看Linux版本：【hostnamectl】","slug":"查看linux版本-【hostnamectl】","link":"#查看linux版本-【hostnamectl】","children":[]},{"level":3,"title":"全文检索：【grep】","slug":"全文检索-【grep】","link":"#全文检索-【grep】","children":[]},{"level":3,"title":"执行某段shell脚本：【source】","slug":"执行某段shell脚本-【source】","link":"#执行某段shell脚本-【source】","children":[]},{"level":3,"title":"以管理员身份运行命令：【sudo】","slug":"以管理员身份运行命令-【sudo】","link":"#以管理员身份运行命令-【sudo】","children":[]},{"level":3,"title":"文件操作：【touch、rm等】","slug":"文件操作-【touch、rm等】","link":"#文件操作-【touch、rm等】","children":[]},{"level":3,"title":"在后台运行脚本：【nohup】","slug":"在后台运行脚本-【nohup】","link":"#在后台运行脚本-【nohup】","children":[]},{"level":3,"title":"下载、安装、卸载软件：【yum、rpm、apt-get】","slug":"下载、安装、卸载软件-【yum、rpm、apt-get】","link":"#下载、安装、卸载软件-【yum、rpm、apt-get】","children":[]},{"level":3,"title":"查看Linux的路由表：【route】","slug":"查看linux的路由表-【route】","link":"#查看linux的路由表-【route】","children":[]},{"level":3,"title":"防火墙操作：【firewalld】","slug":"防火墙操作-【firewalld】","link":"#防火墙操作-【firewalld】","children":[]},{"level":3,"title":"查看环境变量：【env】","slug":"查看环境变量-【env】","link":"#查看环境变量-【env】","children":[]},{"level":3,"title":"文件内容检索、修改：【cat】","slug":"文件内容检索、修改-【cat】","link":"#文件内容检索、修改-【cat】","children":[]},{"level":3,"title":"滚动查看文件：【less】","slug":"滚动查看文件-【less】","link":"#滚动查看文件-【less】","children":[]},{"level":3,"title":"查看日志：【tail】","slug":"查看日志-【tail】","link":"#查看日志-【tail】","children":[]}]},{"level":2,"title":"Linux文件系统结构","slug":"linux文件系统结构","link":"#linux文件系统结构","children":[]},{"level":2,"title":"Shell脚本语法","slug":"shell脚本语法","link":"#shell脚本语法","children":[]},{"level":2,"title":"查看系统配置","slug":"查看系统配置","link":"#查看系统配置","children":[]}],"git":{"updatedTime":1734073104000,"contributors":[{"name":"dongyz8","email":"dongyz8@gdii-yueyun.com","commits":1}]},"filePathRelative":"devops/linux/linux命令速查宝典.md"}');export{d as comp,r as data};
