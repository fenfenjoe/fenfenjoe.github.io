import{_ as t,r as i,o as p,c,a as n,b as s,d as e,e as l}from"./app-CYrzcX6G.js";const o={},r=n("h1",{id:"kubernetes实操笔记",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#kubernetes实操笔记"},[n("span",null,"Kubernetes实操笔记")])],-1),d=n("h3",{id:"参考",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#参考"},[n("span",null,"参考")])],-1),u={href:"https://kuboard.cn/learning/",target:"_blank",rel:"noopener noreferrer"},m=l('<h4 id="k8s单机环境-minikube-学习用" tabindex="-1"><a class="header-anchor" href="#k8s单机环境-minikube-学习用"><span>k8s单机环境：minikube（学习用）</span></a></h4><h5 id="简介" tabindex="-1"><a class="header-anchor" href="#简介"><span>简介</span></a></h5><p><strong>MacOS/Windows</strong><br> minikube -&gt; libmachine -&gt; virtualbox/hyper V -&gt;<br> linux VM -&gt; docker -&gt; localkube<br><strong>Linux</strong><br> minikube -&gt; docker -&gt; localkube</p><blockquote><p>libmachine：虚拟机的驱动程序，负责创建或销毁虚拟机<br> virtualbox/hyper V：开源的虚拟机管理软件<br> localkube：一个独立的Go 语言的二进制包，包含了所有 Kubernetes 的主要组件</p></blockquote><blockquote><p>简单的说，在Mac和Windows系统下，minikube会创建一个虚拟机，并在虚拟机内通过docker去搭建一个单机版的k8s环境（localkube）；<br> 而在Linux上，因为k8s可以直接运行，因此无需设置虚拟机。</p></blockquote><h5 id="在windows上安装minikube" tabindex="-1"><a class="header-anchor" href="#在windows上安装minikube"><span>在Windows上安装minikube</span></a></h5>',6),v={href:"https://minikube.sigs.k8s.io/docs/start/",target:"_blank",rel:"noopener noreferrer"},b=n("br",null,null,-1),k=l(`<h5 id="minikube基本操作" tabindex="-1"><a class="header-anchor" href="#minikube基本操作"><span>minikube基本操作</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="在k8s部署mysql集群" tabindex="-1"><a class="header-anchor" href="#在k8s部署mysql集群"><span>在K8S部署Mysql集群</span></a></h4>`,60);function h(g,y){const a=i("ExternalLinkIcon");return p(),c("div",null,[r,d,n("p",null,[s("【kuboard：免费K8S教程（图文）】"),n("a",u,[s("https://kuboard.cn/learning/"),e(a)])]),m,n("p",null,[n("a",v,[s("https://minikube.sigs.k8s.io/docs/start/"),e(a)]),b,s(" 下载windows版即可")]),k])}const f=t(o,[["render",h],["__file","kubernetes实操笔记.html.vue"]]),E=JSON.parse('{"path":"/devops/kubernetes/kubernetes%E5%AE%9E%E6%93%8D%E7%AC%94%E8%AE%B0.html","title":"Kubernetes实操笔记","lang":"en-US","frontmatter":{"title":"Kubernetes实操笔记","sidebar":"auto"},"headers":[{"level":3,"title":"参考","slug":"参考","link":"#参考","children":[]},{"level":3,"title":"kubectl常用命令","slug":"kubectl常用命令","link":"#kubectl常用命令","children":[]},{"level":3,"title":"K8S实战","slug":"k8s实战","link":"#k8s实战","children":[]}],"git":{"updatedTime":1710772920000,"contributors":[{"name":"Fun_zil","email":"854257920@qq.com","commits":1}]},"filePathRelative":"devops/kubernetes/kubernetes实操笔记.md"}');export{f as comp,E as data};
