import{_ as n,c as a,a as e,o as i}from"./app-CNH3eLtX.js";const l={};function c(t,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="git操作宝典" tabindex="-1"><a class="header-anchor" href="#git操作宝典"><span>git操作宝典</span></a></h1><h2 id="远程代码覆盖本地-reset" tabindex="-1"><a class="header-anchor" href="#远程代码覆盖本地-reset"><span>远程代码覆盖本地（reset）</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">git reset --hard origin/master</span>
