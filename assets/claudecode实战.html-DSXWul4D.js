import{_ as n,c as a,a as e,o as l}from"./app-BA4EsOjK.js";const i={};function d(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="claudecode实战" tabindex="-1"><a class="header-anchor" href="#claudecode实战"><span>claudecode实战</span></a></h1><h2 id="_1-安装与配置-windows" tabindex="-1"><a class="header-anchor" href="#_1-安装与配置-windows"><span>1. 安装与配置（windows）</span></a></h2><ol><li>安装</li></ol><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 全局安装</span></span>
